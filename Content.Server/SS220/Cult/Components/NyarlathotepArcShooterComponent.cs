using Content.Server.SS220.Cult.Nyarlathotep;
...
/// </summary>
[RegisterComponent, Access(typeof(NyarlathotepArcShooterSystem)), AutoGenerateComponentPause]
public sealed partial class NyarlathotepArcShooterComponent : Component
{
    /// <summary>
